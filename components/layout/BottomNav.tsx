...
const WAHref = 'https://wa.me/5491100000000?text=Hola%2C%20quiero%20cotizar%20una%20prepaga'
    ...
    <nav className="fixed bottom-0 left-0 right-0 z-40 md:hidden bg-white border-t border-gray-200 shadow-2xl">
      <div className="flex items-stretch">
        ...
        <a
          ...
          className="flex-1 flex flex-col items-center justify-center py-2 gap-0.5 text-[#25D366] hover:text-[#128C7E] transition-colors"
        >
