...
provinciasSEO.push(
  {
    ...
    faq: [
      ...
      { q: '¿Qué cobertura privada hay en Caballito?', a: 'El Centro Médico Caballito del Hospital Alemán (más de 20 especialidades) es la referencia más fuerte del barrio, junto con el Sanatorio Antártida y la Clínica San Camilo. Para alta complejidad, la mayoría deriva a las sedes centrales de Recoleta o Palermo, a pocos minutos.' },
    ],
    fechaVerificacion: '2026-08-08',
  },
  {
    ...
    prepagas: [
      ...
      { slug: 'swiss-medical', nombre: 'Swiss Medical', enSitio: true, fuerza: 'fuerte', verificado: true,
        resumen: 'Dos de sus ocho sanatorios propios están en Zona Norte (Olivos y San Lucas en San Isidro), sumado a la cartilla premium más amplia del conurbano norte. También tiene sucursal en Mar del Plata (Córdoba 2142) con convenio en el Sanatorio Belgrano, uno de los dos referentes de alta complejidad de la ciudad.',
        cartillaLocal: ['Sanatorio propio en Olivos (Zona Norte)', 'Sanatorio San Lucas, San Isidro (Zona Norte)', 'Sucursal en Mar del Plata con convenio en Sanatorio Belgrano', 'Guardia Ágil con reserva desde el celular'] },
      { slug: 'osde', nombre: 'OSDE', enSitio: true, fuerza: 'fuerte', verificado: true,
      ...
      { slug: 'sancor-salud', nombre: 'Sancor Salud', enSitio: true, fuerza: 'media', verificado: true,
        resumen: 'En el conurbano compite por red de convenios más que por infraestructura propia, pero tiene oficinas comerciales confirmadas en la costa atlántica: Mar del Plata (Av. Luro 3197) y Bahía Blanca (Sarmiento 1101), algo que varias nacionales premium no ofrecen fuera de GBA.',
        cartillaLocal: ['Oficina en Mar del Plata (Av. Luro 3197)', 'Oficina en Bahía Blanca (Sarmiento 1101)', 'Buena relación precio-calidad'] },
      { slug: 'medife', nombre: 'Medifé', enSitio: true, fuerza: 'media', verificado: false,
    ...
    localidades: [
      ...
      { slug: 'tigre-san-fernando', nombre: 'Tigre y San Fernando',
        descripcion: 'El extremo norte del conurbano, con crecimiento fuerte en los últimos años (Nordelta y alrededores). El Sanatorio San Pablo en San Fernando es la referencia de guardia e internación más cercana; en Tigre la cartilla se apoya más en centros de atención ambulatoria que en sanatorios de alta complejidad propios.',
        prestadores: ['Sanatorio San Pablo (San Fernando)', 'Centro Médico Nordelta (Tigre)'] },
      { slug: 'pilar', nombre: 'Pilar',
        descripcion: 'El extremo más alejado de Zona Norte tiene en el Hospital Universitario Austral su gran diferencial: guardia de alta complejidad las 24 horas, internación y las principales especialidades, con más de 50 prepagas incluyéndolo en su cartilla. El Austral también tiene centros ambulatorios satélite en la zona, sin guardia ni internación.',
        prestadores: ['Hospital Universitario Austral'] },
      { slug: 'san-miguel', nombre: 'San Miguel',
        descripcion: 'Cabecera del corredor de la Ruta 8, con el Sanatorio General Sarmiento como referencia histórica del partido desde 1964: guardia de alta complejidad las 24 horas y hemodinamia propia, con cartilla que incluye OSDE, Swiss Medical, Medifé y Omint entre otras.',
        prestadores: ['Sanatorio General Sarmiento'] },
      { slug: 'escobar', nombre: 'Escobar',
        descripcion: 'El extremo norte del corredor, más allá de Pilar, tiene en la Clínica Privada Fátima su principal centro de referencia para internación y guardia, incluida en la cartilla de Sancor Salud, Omint y Hominis entre otras.',
        prestadores: ['Clínica Privada Fátima (Escobar)'] },
      { slug: 'zona-sur', nombre: 'Zona Sur (Quilmes, Lomas de Zamora, Avellaneda)',
        ...
        prestadores: ['Sanatorio de la Trinidad Quilmes', 'Sanatorio Modelo Quilmes', 'Hospital Británico — sede Lomas de Zamora'] },
      { slug: 'lomas-de-zamora', nombre: 'Lomas de Zamora',
        descripcion: 'El partido cabecera de Zona Sur. Hospital Británico tiene sede propia en el centro de Lomas, y Swiss Medical cuenta con un SMG Center de atención ambulatoria en la misma zona. Banfield y Temperley, sus localidades más pobladas, tienen cartilla propia con centros de referencia distintos.',
        prestadores: ['Hospital Británico — sede Lomas de Zamora', 'SMG Center Lomas de Zamora (Swiss Medical)'] },
      { slug: 'banfield', nombre: 'Banfield',
        descripcion: 'La localidad más poblada del partido de Lomas de Zamora, con el Instituto Cardiológico Banfield como referencia de especialidad y el Centro Médico Alsina para consultas médicas e internación general.',
        prestadores: ['Instituto Cardiológico Banfield', 'Centro Médico Alsina'] },
      { slug: 'temperley', nombre: 'Temperley',
        descripcion: 'Localidad del partido de Lomas de Zamora con el Sanatorio Juncal como principal centro de guardia e internación las 24 horas, con cartilla que incluye a Sancor Salud y OSDE entre otras.',
        prestadores: ['Sanatorio Juncal (Temperley)'] },
      { slug: 'quilmes', nombre: 'Quilmes',
        descripcion: 'Uno de los partidos con mejor cartilla de Zona Sur: el Sanatorio de la Trinidad Quilmes (Galeno) es el centro de alta complejidad de referencia, junto con el Sanatorio Modelo Quilmes para internación de mediana complejidad.',
        prestadores: ['Sanatorio de la Trinidad Quilmes', 'Sanatorio Modelo Quilmes'] },
      { slug: 'berazategui', nombre: 'Berazategui',
        descripcion: 'El extremo sureste de Zona Sur, más allá de Quilmes, tiene en el Nuevo Sanatorio Berazategui su referencia de guardia de alta complejidad las 24 horas, con shock room propio para emergencias.',
        prestadores: ['Nuevo Sanatorio Berazategui'] },
      { slug: 'florencio-varela', nombre: 'Florencio Varela',
        descripcion: 'Más allá de Berazategui, en el extremo sureste del conurbano, la Clínica Santa Clara es la referencia privada del partido, con cartilla que incluye a Swiss Medical y Sancor Salud.',
        prestadores: ['Clínica Santa Clara (Florencio Varela)'] },
      { slug: 'adrogue', nombre: 'Adrogué (Almirante Brown)',
        descripcion: 'Cabecera del partido de Almirante Brown, con el IMA (Instituto Médico de Adrogué) como principal centro de referencia para internación y estudios de la zona.',
        prestadores: ['IMA — Instituto Médico de Adrogué'] },
      { slug: 'monte-grande', nombre: 'Monte Grande (Esteban Echeverría)',
        descripcion: 'Cabecera del partido de Esteban Echeverría, con la Clínica Monte Grande como referencia desde 1951: guardia de alta complejidad las 24 horas, terapia intensiva y maternidad propias, con cartilla que incluye OSDE, Swiss Medical, Galeno, Medifé y Sancor Salud.',
        prestadores: ['Clínica Monte Grande'] },
      { slug: 'avellaneda-lanus', nombre: 'Avellaneda y Lanús',
        descripcion: 'El corredor sur más cercano a CABA, con el Sanatorio Itoiz como referencia histórica en Avellaneda y la Clínica Modelo de Lanús cubriendo guardia e internación las 24 horas del lado de Lanús.',
        prestadores: ['Sanatorio Itoiz (Avellaneda)', 'Clínica Modelo de Lanús'] },
      ...
      { slug: 'moron', nombre: 'Morón',
        descripcion: 'Cabecera de Zona Oeste, con la Clínica Modelo de Morón como referencia de mediana complejidad. Para alta complejidad, buena parte de la cartilla privada del partido deriva a Ramos Mejía o a CABA.',
        prestadores: ['Clínica Modelo de Morón'] },
      { slug: 'ramos-mejia-san-justo', nombre: 'Ramos Mejía y San Justo (La Matanza)',
        descripcion: 'El corredor con la cartilla más completa de Zona Oeste: el Sanatorio de la Trinidad Ramos Mejía (Galeno) es el centro de alta complejidad de referencia, con Casa Hospital San Juan de Dios y una sede del Hospital Italiano en San Justo sumando opciones dentro del partido de La Matanza.',
        prestadores: ['Sanatorio de la Trinidad Ramos Mejía', 'Casa Hospital San Juan de Dios', 'Hospital Italiano — sede San Justo'] },
      { slug: 'isidro-casanova', nombre: 'Isidro Casanova, Laferrere y González Catán (La Matanza)',
        descripcion: 'El extremo sur y oeste del partido de La Matanza, más allá de Ramos Mejía y San Justo, tiene en la red Figueroa Paredes —con sedes en Isidro Casanova, Laferrere y González Catán— su principal cartilla privada, integrada a Sancor Salud.',
        prestadores: ['Sanatorio Privado Figueroa Paredes'] },
      { slug: 'ituzaingo-merlo', nombre: 'Ituzaingó y Merlo',
        descripcion: 'El extremo oeste del conurbano tiene en el Sanatorio del Oeste su principal red privada, con sede central en Ituzaingó y una segunda sede en Merlo, ambas con guardia de adultos y pediátrica las 24 horas.',
        prestadores: ['Sanatorio del Oeste — sede Ituzaingó', 'Sanatorio del Oeste — sede Merlo'] },
      ...
      { slug: 'mar-del-plata', nombre: 'Mar del Plata',
        descripcion: 'La ciudad balnearia más poblada del país tiene su propia red privada consolidada, con el Sanatorio Belgrano y la Clínica Pueyrredón como referencias de mayor complejidad. Swiss Medical, Sancor Salud, OSDE y Galeno tienen sucursal de atención propia en la ciudad — la cartilla efectiva no es tan acotada como en otras ciudades del interior.',
        prestadores: ['Sanatorio Belgrano', 'Clínica Pueyrredón', 'Instituto Médico Bolívar', 'Clínica 25 de Mayo'] },
    ...
    faq: [
      ...
      { q: '¿Qué prepagas tienen sucursal en Mar del Plata?', a: 'Swiss Medical, Sancor Salud, OSDE y Galeno tienen oficina de atención propia en la ciudad, con convenio en el Sanatorio Belgrano y la Clínica Pueyrredón, las dos referencias de mayor complejidad. Es una de las ciudades del interior bonaerense con mejor cartilla efectiva.' },
      { q: '¿Cuál es la mejor prepaga en Bahía Blanca?', a: 'Sancor Salud y Galeno tienen oficina propia en la ciudad. El Hospital Privado del Sur y el Hospital Italiano Regional del Sur son los dos centros de mayor complejidad: verificá cuál de los dos incluye tu plan antes de contratar, porque no todas las prepagas cubren ambos.' },
    ],
    fechaVerificacion: '2026-08-08',
  },
  {
    ...
    nombre: 'Entre Ríos',
    zonaKey: 'entre-rios',
    capitalNombre: 'Paraná',
    descripcion:
      'Entre Ríos tiene un mercado de salud privada repartido entre tres ciudades: Paraná (capital), Concordia y Gualeguaychú, cada una con su propia red de sanatorios. Las nacionales (Swiss Medical, OSDE) compiten con las regionales del litoral (Sancor Salud, Federada Salud, Avalian, Prevención) y con Amur Salud, una prepaga de origen santafesino que expandió su red de convenios hacia la provincia. Es un mercado más chico que Córdoba o Santa Fe: comparar cartilla real antes de contratar pesa más acá que en provincias con más oferta.',
    rankingIntro:
      'Ranking según cartilla efectiva en Entre Ríos: en un mercado con menos jugadores que el resto del litoral, importa más verificar qué sanatorios de Paraná, Concordia o Gualeguaychú cubre cada plan.',
    prepagas: [
      { slug: 'sancor-salud', nombre: 'Sancor Salud', enSitio: true, fuerza: 'fuerte', verificado: true,
      ...
      { slug: 'federada-salud', nombre: 'Federada Salud', enSitio: true, fuerza: 'fuerte', verificado: true,
        resumen: 'Nacida en Rosario, con fuerte despliegue en todo el litoral. 250+ agencias en el país y buena presencia en el corredor Paraná–Santa Fe.',
        cartillaLocal: ['Red histórica en el litoral', 'Agencias de atención en la provincia'] },
      { slug: 'prevencion-salud', nombre: 'Prevención Salud', enSitio: true, fuerza: 'media', verificado: false,
        resumen: 'Del grupo Sancor Seguros, con presencia declarada en el interior del país, Entre Ríos incluida.',
        cartillaLocal: ['Plan A1 con cobertura nacional', 'Oficinas en la región'] },
      { slug: 'avalian', nombre: 'Avalian', enSitio: true, fuerza: 'media', verificado: false,
        resumen: 'La cooperativa con llegada al interior también declara presencia en Entre Ríos. Competitiva en precio frente a las nacionales premium.',
        cartillaLocal: ['Presencia declarada en la provincia', 'Cartilla sujeta a verificación al cotizar'] },
      { slug: 'amur-salud', nombre: 'Amur Salud', enSitio: false, fuerza: 'media', verificado: true,
        resumen: 'Prepaga de origen santafesino (sede central en Santa Fe) con sucursal propia en Paraná y una estrategia activa de expansión por convenios hacia Entre Ríos. Vale cotizarla como alternativa regional.',
        cartillaLocal: ['Sucursal en Paraná (25 de Mayo 292)', 'Red de farmacias propias en la región', 'En expansión hacia el interior entrerriano'] },
    ],
    localidades: [
      { slug: 'parana', nombre: 'Paraná',
        descripcion: 'La capital provincial concentra la red privada más grande de Entre Ríos: Sanatorio Río, Sanatorio La Entrerriana, Instituto Rawson e Instituto Privado de Pediatría son las referencias locales. Amur Salud tiene ahí su sucursal entrerriana.',
        prestadores: ['Sanatorio Río', 'Sanatorio La Entrerriana', 'Instituto Rawson', 'Instituto Privado de Pediatría'] },
      { slug: 'concordia', nombre: 'Concordia',
        descripcion: 'La segunda ciudad de la provincia tiene su propia red de referencia: el Instituto Médico Quirúrgico Garat y el Sanatorio Concordia cubren la mayor parte de la demanda local; la alta complejidad deriva a Paraná.',
        prestadores: ['Instituto Médico Quirúrgico Garat', 'Sanatorio Concordia'] },
      { slug: 'gualeguaychu', nombre: 'Gualeguaychú',
        descripcion: 'El sureste entrerriano tiene su red propia: Sanatorio Cometra, Sanatorio AGOS y Clínica Pronto. Al elegir plan, verificá si incluye estos prestadores o si deriva a Paraná para estudios de mayor complejidad.',
        prestadores: ['Sanatorio Cometra', 'Sanatorio AGOS', 'Clínica Pronto'] },
    ],
    prestadoresClave: ['Sanatorio Río (Paraná)', 'Sanatorio La Entrerriana (Paraná)', 'Instituto Médico Quirúrgico Garat (Concordia)', 'Sanatorio Cometra (Gualeguaychú)'],
    obraSocialProvincial: {
      sigla: 'IOSPER',
  ...
  },
  {
    ...
    nombre: 'Misiones',
    zonaKey: 'misiones',
    capitalNombre: 'Posadas',
    descripcion:
      'Misiones tiene un mercado de salud privada concentrado en Posadas, con dos sanatorios de referencia —Sanatorio Boratti (fundado en 1960, referencia en ginecología y obstetricia) y Sanatorio Camino (con atención materno-infantil exclusiva)— y menos oferta de prepagas que las provincias del centro del país: apenas tres empresas tienen presencia declarada. Es un mercado donde comparar antes de contratar es especialmente importante, justamente por la oferta más acotada.',
    rankingIntro:
      'Ranking según cartilla efectiva en Misiones: con solo tres prepagas nacionales operando en la provincia, la diferencia entre planes pasa por si cubren Sanatorio Boratti o Sanatorio Camino, las dos referencias de Posadas.',
    prepagas: [
      { slug: 'sancor-salud', nombre: 'Sancor Salud', enSitio: true, fuerza: 'fuerte', verificado: true,
        resumen: 'Red nacional con cartilla provincial publicada; una de las opciones con mejor relación precio/cartilla en Misiones.',
        cartillaLocal: ['Cartilla provincial publicada (PDF oficial)', 'Presencia en Posadas'] },
      { slug: 'galeno', nombre: 'Galeno', enSitio: true, fuerza: 'media', verificado: true,
        resumen: 'Tiene sucursal de atención propia en Posadas y cobertura nacional en todos sus planes. La atención es por cartilla de convenio: sus sanatorios propios (Trinidad) están en Buenos Aires.',
        cartillaLocal: ['Sucursal de atención en Posadas', 'Cobertura por convenios locales'] },
      { slug: 'osde', nombre: 'OSDE', enSitio: true, fuerza: 'media', verificado: false,
        resumen: 'Red nacional con presencia declarada en Misiones; la cartilla en Posadas es más acotada que en capitales con filial propia.',
        cartillaLocal: ['Cobertura declarada en Misiones', 'Cartilla sujeta a verificación al cotizar'] },
      { slug: 'prevencion-salud', nombre: 'Prevención Salud', enSitio: true, fuerza: 'media', verificado: false,
        resumen: 'Del grupo Sancor Seguros, con presencia declarada en el interior del país, Misiones incluida.',
        cartillaLocal: ['Plan A1 con cobertura nacional', 'Oficinas en la región'] },
    ],
    localidades: [
      { slug: 'posadas', nombre: 'Posadas',
        descripcion: 'La capital provincial concentra toda la red privada relevante de Misiones: el Sanatorio Boratti (referencia histórica en ginecología y obstetricia desde 1960) y el Sanatorio Camino (con atención materno-infantil exclusiva) son los dos centros de mayor complejidad de la ciudad.',
        prestadores: ['Sanatorio Boratti', 'Sanatorio Camino'] },
    ],
    prestadoresClave: ['Sanatorio Boratti (Posadas)', 'Sanatorio Camino (Posadas)'],
    obraSocialProvincial: {
      sigla: 'IPS',
    ...
    faq: [
      ...
      { q: '¿Qué sanatorios privados hay en Posadas?', a: 'Los dos de mayor referencia son el Sanatorio Boratti, con más de 60 años de trayectoria y fuerte en ginecología y obstetricia, y el Sanatorio Camino, con atención materno-infantil exclusiva. Qué cubra cada prepaga depende del plan.' },
      { q: 'Tengo IPS Misiones, ¿puedo contratar una prepaga?', a: 'Sí. El IPS es la obra social provincial de los empleados públicos misioneros y no se elige voluntariamente, pero podés sumar una prepaga en paralelo para acceder a cartilla privada sin restricciones.' },
      { q: '¿Por qué hay menos prepagas en Misiones que en otras provincias?', a: 'El mercado de salud privada en el NEA es más chico que en el centro del país. Eso hace que comparar las pocas opciones disponibles —Sancor Salud, Galeno, OSDE y Prevención Salud— importe todavía más antes de contratar.' },
    ],
  ...
  },
  {
    ...
    nombre: 'Chaco',
    zonaKey: 'chaco',
    capitalNombre: 'Resistencia',
    descripcion:
      'El mercado de salud privada del Chaco se concentra en Resistencia, con Sanatorio Güemes, Sanatorio La Sagrada Familia y Sanatorio Modelo como principales referencias. Es una de las provincias con menos oferta de prepagas del país —tres empresas nacionales, con Galeno sumando sucursal propia—, lo que hace que verificar la cartilla real antes de contratar sea más importante que en el centro del país.',
    rankingIntro:
      'Ranking según cartilla efectiva en Chaco: con una oferta acotada de prepagas, la diferencia entre planes pasa por qué sanatorios de Resistencia cubre cada uno.',
    prepagas: [
      { slug: 'sancor-salud', nombre: 'Sancor Salud', enSitio: true, fuerza: 'fuerte', verificado: true,
        resumen: 'Red nacional con cartilla provincial publicada; la opción con mejor relación precio/cartilla declarada en la provincia.',
        cartillaLocal: ['Cartilla provincial publicada (PDF oficial)', 'Presencia en Resistencia'] },
      { slug: 'galeno', nombre: 'Galeno', enSitio: true, fuerza: 'media', verificado: true,
        resumen: 'Tiene sucursal de atención propia en Resistencia y cobertura nacional en todos sus planes. Sus sanatorios propios (Trinidad) están en Buenos Aires: acá la atención es por convenio.',
        cartillaLocal: ['Sucursal de atención en Resistencia', 'Cobertura por convenios locales'] },
      { slug: 'osde', nombre: 'OSDE', enSitio: true, fuerza: 'media', verificado: false,
        resumen: 'Red nacional con presencia declarada en Chaco; cartilla más acotada que en capitales con filial propia.',
        cartillaLocal: ['Cobertura declarada en Chaco', 'Cartilla sujeta a verificación al cotizar'] },
      { slug: 'prevencion-salud', nombre: 'Prevención Salud', enSitio: true, fuerza: 'media', verificado: true,
        resumen: 'Con oficina propia en Resistencia (López y Planes 45), del grupo Sancor Seguros.',
        cartillaLocal: ['Oficina propia en Resistencia', 'Plan A1 con cobertura nacional'] },
    ],
    localidades: [
      { slug: 'resistencia', nombre: 'Resistencia',
        descripcion: 'La capital provincial concentra la red privada del Chaco: Sanatorio Güemes, Sanatorio La Sagrada Familia, Sanatorio Modelo y Sanatorio Chaco Oeste son las referencias de mayor complejidad de la ciudad.',
        prestadores: ['Sanatorio Güemes (Resistencia)', 'Sanatorio La Sagrada Familia', 'Sanatorio Modelo (Chaco)', 'Sanatorio Chaco Oeste'] },
    ],
    prestadoresClave: ['Sanatorio Güemes (Resistencia)', 'Sanatorio La Sagrada Familia', 'Sanatorio Modelo (Chaco)'],
    obraSocialProvincial: {
      sigla: 'INSSSEP',
    ...
    faq: [
      ...
      { q: '¿Qué sanatorios privados hay en Resistencia?', a: 'Los principales son el Sanatorio Güemes, el Sanatorio La Sagrada Familia, el Sanatorio Modelo y el Sanatorio Chaco Oeste. Qué cubra cada prepaga depende del plan: verificalo al cotizar.' },
      { q: 'Tengo INSSSEP, ¿puedo contratar una prepaga?', a: 'Sí. INSSSEP es la obra social provincial de los empleados públicos chaqueños y no se elige voluntariamente, pero podés sumar una prepaga en paralelo para acceder a cartilla privada sin restricciones.' },
      { q: '¿Por qué hay menos prepagas en Chaco que en otras provincias?', a: 'El mercado de salud privada del NEA es más chico que en el centro del país. Con menos oferta, comparar entre las opciones disponibles —Sancor Salud, Galeno, OSDE y Prevención Salud— importa todavía más antes de elegir.' },
    ],
    fechaVerificacion: '2026-07-22',
  },
  {
    ...
    nombre: 'Corrientes',
    zonaKey: 'corrientes',
    capitalNombre: 'Corrientes capital',
    descripcion:
      'Corrientes tiene un mercado de salud privada concentrado en la capital provincial, con Sanatorio del Norte, Sanatorio del Litoral y Sanatorio San Juan como principales referencias. OSDE mantiene filial propia con cartilla publicada oficialmente, y Sancor Salud y Prevención Salud completan una oferta más acotada que en el centro del país.',
    rankingIntro:
      'Ranking según cartilla efectiva en Corrientes: con OSDE como única filial confirmada en la provincia, la diferencia entre planes pasa por qué sanatorios de la capital cubre cada uno.',
    prepagas: [
      { slug: 'osde', nombre: 'OSDE', enSitio: true, fuerza: 'fuerte', verificado: true,
        resumen: 'Mantiene filial propia en Corrientes con cartilla publicada oficialmente (vigencia verificada junio 2026): es la prepaga con presencia más formalizada en la provincia.',
        cartillaLocal: ['Filial Corrientes con cartilla oficial publicada', 'Red de convenios en la capital provincial'] },
      { slug: 'sancor-salud', nombre: 'Sancor Salud', enSitio: true, fuerza: 'fuerte', verificado: true,
        resumen: 'Red nacional con cartilla provincial publicada; buena relación precio/cartilla declarada en la provincia.',
        cartillaLocal: ['Cartilla provincial publicada (PDF oficial)', 'Presencia en Corrientes capital'] },
      { slug: 'prevencion-salud', nombre: 'Prevención Salud', enSitio: true, fuerza: 'media', verificado: false,
        resumen: 'Del grupo Sancor Seguros, con presencia declarada en el interior del país, Corrientes incluida.',
        cartillaLocal: ['Plan A1 con cobertura nacional', 'Oficinas en la región'] },
    ],
    localidades: [
      { slug: 'corrientes-capital', nombre: 'Corrientes capital',
        descripcion: 'La capital provincial concentra la red privada de Corrientes: Sanatorio del Norte, Sanatorio del Litoral y Sanatorio San Juan son las referencias de mayor complejidad, junto con la Clínica Maternal del Iberá para atención materno-infantil.',
        prestadores: ['Sanatorio del Norte', 'Sanatorio del Litoral', 'Sanatorio San Juan', 'Clínica Maternal del Iberá'] },
    ],
    prestadoresClave: ['Sanatorio del Norte (Corrientes)', 'Sanatorio del Litoral', 'Sanatorio San Juan (Corrientes)'],
    obraSocialProvincial: {
      sigla: 'IOSCOR',
    ...
    faq: [
      ...
      { q: '¿Qué sanatorios privados hay en Corrientes capital?', a: 'Los principales son el Sanatorio del Norte, el Sanatorio del Litoral, el Sanatorio San Juan y la Clínica Maternal del Iberá para atención materno-infantil. Qué cubra cada prepaga depende del plan: verificalo al cotizar.' },
      { q: 'Tengo IOSCOR, ¿puedo contratar una prepaga?', a: 'Sí. IOSCOR es la obra social provincial de los empleados públicos correntinos y no se elige voluntariamente, pero podés sumar una prepaga en paralelo para acceder a cartilla privada sin restricciones.' },
      { q: '¿OSDE tiene cartilla oficial en Corrientes?', a: 'Sí, OSDE publica una cartilla específica para su filial Corrientes, con vigencia actualizada periódicamente. Es la prepaga con presencia más formalizada de la provincia.' },
    ],
    fechaVerificacion: '2026-07-22',
  },
)
