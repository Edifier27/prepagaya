  ...
  },
  {
    ...
    localidades: [
      ...
      { slug: 'zona-sur', nombre: 'Zona Sur (Quilmes, Lomas de Zamora, Avellaneda)',
        ...
        prestadores: ['Sanatorio Juncal (Temperley)', 'Sanatorio de la Trinidad Quilmes', 'Sanatorio Modelo Quilmes', 'Hospital Británico — sede Lomas de Zamora'] },
      { slug: 'lomas-de-zamora', nombre: 'Lomas de Zamora',
        descripcion: 'El partido cabecera de Zona Sur, que incluye a Banfield y Temperley entre sus localidades. Hospital Británico tiene sede propia en el partido, Swiss Medical cuenta con un SMG Center de atención ambulatoria en el centro de Lomas, y en Banfield puntualmente son referencia el Instituto Cardiológico Banfield y el Centro Médico Alsina.',
        prestadores: ['Hospital Británico — sede Lomas de Zamora', 'SMG Center Lomas de Zamora (Swiss Medical)', 'Sanatorio Juncal (Temperley)', 'Instituto Cardiológico Banfield'] },
