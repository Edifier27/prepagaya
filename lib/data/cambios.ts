...
export const cambiosRecomendados: CambioRecomendado[] = [
  ...
  },
  {
    ...
    destinoPrecio: 167000,
    deltaMensual: 267250 - 167000,
  ...
  },
  {
    ...
    razon: 'El Plan Global de Omint tiene su red concentrada en 3 sanatorios propios de CABA/GBA (Bazterrica, Del Sol, Santa Isabel). El Plan 310 de OSDE tiene un nivel de precio bastante más accesible y da acceso a una red de 140.000 profesionales en todo el país, incluido el Hospital Alemán.',
    ...
    ganas: ['Red de 140.000 profesionales contra 10.000 de Omint', '380+ centros de atención en todo el país', 'Hospital Alemán en cartilla desde el plan 310', 'El mayor ahorro estimado de toda esta comparación'],
