...
export const testimonios: Testimonio[] = [
  // Swiss Medical
  { id: 1,  nombre: 'Martín R.',    ciudad: 'Buenos Aires', prepagaSlug: 'swiss-medical', planNombre: 'SMG20',    fecha: 'Mayo 2026',     rating: 5, texto: 'El SMG20 es lo mejor que contratamos. Sin copago, se atienden en todos los sanatorios propios y la app es excelente. Cambiamos desde OSDE 210 y notamos la diferencia.' },
  ...
  { id: 36, nombre: 'Julián B.',    ciudad: 'Buenos Aires', prepagaSlug: 'swiss-medical', planNombre: 'Sport Plan', fecha: 'Julio 2026',  rating: 5, texto: 'Corro maratones hace años y el Sport Plan es único: me reintegra el gimnasio, la nutricionista y las sesiones de kinesiología. Ninguna otra prepaga tiene algo parecido para quien entrena en serio.', },

  // OSDE
  { id: 6,  nombre: 'Lucía M.',     ciudad: 'Buenos Aires', prepagaSlug: 'osde', planNombre: 'Plan 310',  fecha: 'Junio 2026',    rating: 5, texto: 'El Plan 310 tiene la red más grande que encontré. Hospital Italiano, Alemán, médico a domicilio sin cargo. Para una familia de 4 es la opción más completa.' },
  ...
  { id: 37, nombre: 'Nadia F.',     ciudad: 'Buenos Aires', prepagaSlug: 'premedic', planNombre: 'Plan 400', fecha: 'Julio 2026',  rating: 5, texto: 'Me sorprendió que tuviera dental propio: fui a Smile Group por un implante y me salió la mitad de lo que cotizaba particular. Para lo que pago de cuota, no me esperaba ese nivel de cobertura.', },
  { id: 38, nombre: 'Emiliano D.',  ciudad: 'Córdoba',      prepagaSlug: 'premedic', planNombre: 'Plan 300', fecha: 'Junio 2026',  rating: 4, texto: 'Vengo de una prepaga cara y con Premedic no perdí nada para lo que uso: consultas, urgencias y ahora también arreglé la ortodoncia de mi hija con descuento en Smile Group.', },
  ...
  { id: 33, nombre: 'Patricia O.',  ciudad: 'Neuquén',      prepagaSlug: 'galeno', planNombre: 'Oro 440',   fecha: 'Abril 2026',   rating: 5, texto: 'Galeno en Neuquén tiene el Sanatorio de la Trinidad propio. El Oro 440 me da acceso a todos los especialistas sin tener que viajar a Buenos Aires. Excelente.' },

  // Luis Pasteur
  { id: 34, nombre: 'Verónica M.',  ciudad: 'Buenos Aires', prepagaSlug: 'luis-pasteur', planNombre: 'Plan N', fecha: 'Junio 2026',  rating: 5, texto: 'El Plan N de Luis Pasteur es una joya escondida. Sin copago en consultas, el dental incluido y 60% en farmacias. Pasé de Hominis y la diferencia en cobertura es notable para el mismo precio.' },
