        ...
        <div className="container max-w-3xl mx-auto">
          ...
          <div className="space-y-4">
            {[
              ...
              { t: 'No waiting periods on most essential care', d: 'By law (Ley 26.682), mandatory health program (PMO) services — doctor visits, tests, hospitalization, emergencies — cannot carry waiting periods and start on day one. Maternity is the one exception: the standard waiting period is 2 months from your enrollment date (measured against your due date), and companies will generally decline enrollment if pregnancy is disclosed upfront.' },
