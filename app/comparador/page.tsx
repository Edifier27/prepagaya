...
export default function ComparadorPage() {
  return (
    <>
      ...
      {/* Hero */}
      <section className="bg-gradient-to-b from-[#f0f4ff] to-white border-b border-gray-100 py-14">
        <div className="container max-w-3xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 bg-white border border-blue-100 text-[#E8002D] text-xs font-semibold px-4 py-2 rounded-full mb-5 shadow-sm">
          ...
          <p className="text-gray-500 text-base max-w-lg mx-auto leading-relaxed">
            Respondé 5 preguntas simples y te mostramos los mejores planes con precio real y <strong className="text-gray-700">25% de descuento</strong> por contratar online.
          </p>
          ...
          <div className="flex flex-wrap items-center justify-center gap-6 mt-7 text-xs text-gray-500">
            <span className="flex items-center gap-2">
              ...
              <strong className="text-gray-700">+6 prepagas</strong> analizadas
            </span>
            <span className="flex items-center gap-2">
              ...
              Precios actualizados <strong className="text-gray-700">Junio 2026</strong>
            </span>
            <span className="flex items-center gap-2">
