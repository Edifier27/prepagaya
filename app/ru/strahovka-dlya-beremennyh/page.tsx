...
const faqs = [
  {
    ...
    a: 'Если вы оформляете prepaga ДО наступления беременности, период ожидания не применяется — полное покрытие родов с первого дня. Если вы оформляете страховку УЖЕ будучи беременной, большинство компаний применяет период ожидания около 9–10 месяцев на покрытие самих родов (естественных или кесарева сечения). Наблюдение беременности (осмотры, УЗИ) обычно покрывается раньше или без периода ожидания — уточняйте точные условия при оформлении.',
  },
  {
  ...
  {
    q: 'Стоит ли оформлять страховку до или после наступления беременности?',
    a: 'Однозначно до — это полностью снимает вопрос периода ожидания на роды и даёт время спокойно выбрать подходящую compaнию и план. Если вы уже беременны и планируете переезд в Аргентину, оформляйте страховку как можно раньше: чем раньше срок беременности на момент оформления, тем больше шансов, что 9–10-месячный период ожидания истечёт до предполагаемой даты родов.',
  },
  {
      ...
      <section className="bg-gradient-to-b from-gray-50 to-white border-b border-gray-100 py-12">
        <div className="container max-w-3xl mx-auto">
          ...
          <p className="text-gray-600 leading-relaxed mb-6">
            Многие семьи, переезжающие в Аргентину, делают это уже во время беременности. Самое важное — сроки:
            если оформить prepaga до наступления беременности, период ожидания на роды не применяется; если уже
            будучи беременной — обычно действует период ожидания около 9–10 месяцев именно на сами роды.
          </p>
          <Link
            href="/comparador"
      ...
      <section className="py-10 bg-white">
        <div className="container max-w-3xl mx-auto">
          ...
          <div className="space-y-4">
            {[
              { t: 'Период ожидания зависит от срока оформления', d: 'Оформили страховку до беременности — покрытие родов с первого дня. Оформили уже будучи беременной — как правило, около 9–10 месяцев ожидания на сами роды (естественные или кесарево). Наблюдение беременности обычно покрывается раньше — уточняйте точные условия у консультанта при оформлении.' },
              { t: 'PMO гарантирует полное ведение беременности', d: 'Обязательная программа покрытия включает: осмотры, УЗИ, анализы на протяжении всей беременности — независимо от периода ожидания на сами роды.' },
              { t: 'Роды и госпитализация', d: 'Естественные роды или кесарево сечение, госпитализация матери и новорождённого, базовая неонатология — всё включено в PMO после истечения применимого периода ожидания.' },
              { t: 'Неонатология высокой сложности', d: 'Если новорождённому нужна госпитализация в неонатологии высокой сложности, она также покрывается.' },
            ].map((item, i) => (
