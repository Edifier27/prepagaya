...
const faqs = [
  ...
  },
  {
    ...
    a: 'Да — по закону (Ley 26.682) программа обязательного медицинского покрытия (PMO) включает полное ведение беременности и роды без периода ожидания с первого дня действия плана. Это одна из причин, по которой многие семьи, переезжающие в Аргентину, оформляют местную prepaga, а не туристическую страховку.',
  },
]
