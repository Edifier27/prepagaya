...
const faqs = [
  ...
  },
  {
    ...
    a: <>Да, по обязательной программе покрытия (PMO). Наблюдение беременности покрывается практически сразу, а на сами роды обычно действует период ожидания около 9–10 месяцев, если вы оформляете страховку уже будучи беременной — если оформить до беременности, периода ожидания нет. <Link href="/ru/strahovka-dlya-beremennyh" className="text-[#E8002D] hover:underline font-medium">Подробнее о страховке для беременных →</Link></>,
  },
]
