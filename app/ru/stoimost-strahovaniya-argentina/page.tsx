...
const faqs = [
  ...
  },
  {
    ...
    a: 'Да, большинство компаний дают около 15% скидки от базовой цены за оформление онлайн с автоматическим ежемесячным списанием — эта скидка уже учтена в ценах, которые вы получаете через PrepagaYa.',
  },
  {
